...
CREATE TEMP TABLE target_load_test_group_ids (
...
INSERT INTO target_load_test_group_ids (id)
SELECT DISTINCT reservation.reservation_group_id
...
USING target_load_test_group_ids target
