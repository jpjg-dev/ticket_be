...
import com.jipi.ticket_ledger.event.application.EventQueryService;
...
public class EventController {
    ...
    public List<EventListResponse> getEvents() {
        return eventQueryService.getEvents().events();
    }
    ...
    public SeatListResponse getSeats(@PathVariable Long scheduleId) {
        return seatQueryService.getSeats(scheduleId);
    }
    ...
    public List<SeatAvailabilityResponse> getScheduleAvailability(@RequestParam Collection<Long> scheduleIds) {
        return seatQueryService.getScheduleAvailability(scheduleIds);
    }
}
