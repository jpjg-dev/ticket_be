...
const caseName = __ENV.CASE_NAME || "popular-event-payment-arrival-rate-spike";
...
if (!["smoke", "arrival"].includes(loadProfile)) {
  throw new Error("LOAD_PROFILE must be one of: smoke, arrival.");
}
