...
public final class LogEvents {
    ...
    public static final String FEATURE_FLAG_QUEUE_MODE_CHANGED = "FEATURE_FLAG_QUEUE_MODE_CHANGED";
    public static final String FEATURE_FLAG_QUEUE_MODE_RUNTIME_FALLBACK_ENFORCED = "FEATURE_FLAG_QUEUE_MODE_RUNTIME_FALLBACK_ENFORCED";
    public static final String FEATURE_FLAG_QUEUE_MODE_CACHE_REFRESH_FAILED = "FEATURE_FLAG_QUEUE_MODE_CACHE_REFRESH_FAILED";
}
